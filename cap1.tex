...
\section{Produtório}
Muitas vezes será necessário representarmos o produto de $n$ números, da sequência $\{x_n\}_{n\in \mathbb{N}}$, que será feita pelo símbolo.
...
\begin{enumerate}
    \item [(i)] Prove as identidades abaixo (o zero aqui não é natural):
    \begin{enumerate}
...
\noindent \exemplo Considere uma sequência $(x_n)$ definida por
	\begin{equation}
		\begin{cases}
		\label{PA12}
		x_1 = k\\
	...
	\end{defin}
	\noindent \exemplo Vamos classificar as recorrências abaixo, quanto à ordem
	\begin{enumerate}
		\item[(a)] $\begin{cases}
		x_1 = 1\\
		x_{n+1} = 2x_n + 1
	...
	\noindent \exemplo Use a fórmula fechada, demonstrada acima para mostrar solucionar as recorrências
	\begin{enumerate}
		\item[(a)] $a_{n} = na_{n-1} $;
		\item[(b)] $a_{n} = 3a_{n-1}$;
 ...
 \noindent \exemplo Use a equação (\ref{aaa}) para solucionar as recorrências
 	 \begin{enumerate}
...
\begin{align}
    ...
    \varphi^2 - 10\varphi + 24 &= 0, \label{polc}
\end{align}
